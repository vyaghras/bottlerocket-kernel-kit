...
Any resulting diff in a [`config-full-bottlerocket-aarch64`](https://github.com/bottlerocket-os/bottlerocket-kernel-kit/blob/develop/packages/kernel-5.15/config-full-bottlerocket-aarch64) 
or [`config-full-bottlerocket-x86_64`](https://github.com/bottlerocket-os/bottlerocket-kernel-kit/blob/develop/packages/kernel-5.15/config-full-bottlerocket-x86_64) file should be PR'd to this package for review.
